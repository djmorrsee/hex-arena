...
public static class CoordinateSystems : object
{
	...
	public static XYZCoordinates AxialToXY (AxialCoordinates coord)
	{
		...
		xy.x = cube.x + (cube.z - (cube.z & 1)) / 2;
		xy.y = cube.z;
		xy.height = cube.height;
		
		return xy;
	}
	
	static CubeCoordinates AxialToCube (AxialCoordinates coord)
	{
	...
	static CubeCoordinates XYToCube (XYZCoordinates coord)
	{
		CubeCoordinates cube;
